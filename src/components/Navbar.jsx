                    ...
                    this.state.windowBig === true ?
                        ...
                        <div style={{backgroundColor: theme.navbarBackground}} id="bigMenu">
                            ...
                            <div  id="bottom-container">
                                <button className="menuItem"><Link style={{color: theme.textNavbarColor}} className="menuItemLink" to="/timeline">The Timeline</Link></button>
                                ...
                                <button className="menuItem"><Link style={{color: theme.textNavbarColor}} className="menuItemLink" to="/team">About US</Link></button>
